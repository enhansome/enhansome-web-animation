...
* [Raphael](https://github.com/DmitryBaranovskiy/raphael) ⭐ 11,268 | 🐛 347 | 🌐 JavaScript | 📅 2024-01-12 - JavaScript Vector Library.
...
* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 72,800 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 28,377 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
...
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,437 | 🐛 467 | 🌐 TypeScript | 📅 2026-09-13 - JavaScript canvas library with animation support.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,079 | 🐛 430 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting – Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
* [Konva](https://github.com/konvajs/konva) ⭐ 14,788 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-08 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,979 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-13 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
* [Two.js](https://github.com/jonobr1/two.js) ⭐ 8,657 | 🐛 40 | 🌐 JavaScript | 📅 2026-09-12 - A renderer agnostic two-dimensional drawing api for the web with animation support.
...
* [Pts.js](https://github.com/williamngan/pts) ⭐ 5,343 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-13 - Pts is a typescript/javascript library for visualization and creative-coding.
...
* [Motion](https://github.com/framer/motion) ⭐ 33,589 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-13 - Open source, production-ready animation and gesture library for React.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,057 | 🐛 150 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,979 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-13 - ReactJS wrapper for *tsParticles*
