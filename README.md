...
* [Lottie](https://github.com/airbnb/lottie-web) ⭐ 32,127 | 🐛 857 | 🌐 JavaScript | 📅 2025-09-01 - Render After Effects animations natively on the web as SVG or Canvas.
...
* [Svg.js](https://github.com/svgdotjs/svg.js) ⭐ 11,829 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-04 - The lightweight library for manipulating and animating SVG.
* [Raphael](https://github.com/DmitryBaranovskiy/raphael) ⭐ 11,264 | 🐛 347 | 🌐 JavaScript | 📅 2024-01-12 - JavaScript Vector Library.
* [Flubber](https://github.com/veltman/flubber) ⭐ 6,934 | 🐛 19 | 🌐 JavaScript | 📅 2022-11-08 - Tools for smoother SVG shape morphing and interpolation.
...
* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 73,120 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 28,637 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
...
* [Mojs](https://github.com/mojs/mojs) ⭐ 18,785 | 🐛 37 | 🌐 CoffeeScript | 📅 2026-07-30 - The motion graphics toolbelt for the web.
* [Velocity](https://github.com/julianshapiro/velocity) ⭐ 17,193 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [AutoAnimate](https://github.com/formkit/auto-animate) ⭐ 13,923 | 🐛 44 | 🌐 TypeScript | 📅 2026-07-10 - Zero-config, drop-in animation utility for smooth DOM transitions.
* [Theatre.js](https://github.com/theatre-js/theatre) ⭐ 12,701 | 🐛 141 | 🌐 TypeScript | 📅 2024-08-14 - Motion design editor for the web.
...
* [Rive](https://github.com/rive-app/rive-wasm) ⭐ 970 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-26 - Web runtime for interactive Rive animations.
...
* [Animate.css](https://github.com/daneden/animate.css) ⭐ 82,826 | 🐛 80 | 🌐 CSS | 📅 2024-07-29 -  A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [Bounce.js](https://github.com/tictail/bounce.js) ⭐ 6,152 | 🐛 12 | 🌐 CSS | 📅 2020-09-03 - Create beautiful CSS3 powered animations in no time.
* [CSS Doodle](https://github.com/css-doodle/css-doodle) ⭐ 6,048 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-25 - A web component for drawing patterns with CSS.
...
* [Three.js](https://github.com/mrdoob/three.js) ⭐ 115,915 | 🐛 374 | 🌐 JavaScript | 📅 2026-09-26 - JavaScript 3D library.
* [PixiJS](https://github.com/pixijs/pixijs) ⭐ 48,228 | 🐛 341 | 🌐 TypeScript | 📅 2026-09-25 - Fast 2D WebGL renderer for interactive graphics and animation.
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,464 | 🐛 470 | 🌐 TypeScript | 📅 2026-09-26 - JavaScript canvas library with animation support.
* [p5.js](https://github.com/processing/p5.js) ⭐ 24,048 | 🐛 526 | 🌐 JavaScript | 📅 2026-09-25 - Creative coding library for drawing and animation on canvas.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,830 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [canvas-confetti](https://github.com/catdad/canvas-confetti) ⭐ 12,766 | 🐛 41 | 🌐 JavaScript | 📅 2025-10-25 - Performant confetti animation in the browser.
* [Zdog](https://github.com/metafizzy/zdog) ⭐ 10,662 | 🐛 55 | 🌐 JavaScript | 📅 2023-07-18 - Round, flat, designer-friendly pseudo-3D engine for canvas and SVG.
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,984 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-25 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
...
* [Vanta.js](https://github.com/tengbao/vanta) ⭐ 7,075 | 🐛 77 | 🌐 JavaScript | 📅 2024-03-03 - Animated 3D backgrounds for your website.
* [Pts.js](https://github.com/williamngan/pts) ⭐ 5,346 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-26 - Pts is a typescript/javascript library for visualization and creative-coding.
...
* [AOS](https://github.com/michalsnik/aos) ⭐ 28,052 | 🐛 375 | 🌐 JavaScript | 📅 2024-03-26 - Animate on scroll library.
...
* [Lenis](https://github.com/darkroomengineering/lenis) ⭐ 16,031 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-22 - Lightweight, accessible smooth scroll library.
* [ScrollMagic](https://github.com/janpaepke/ScrollMagic) ⭐ 14,958 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-25 - The JavaScript library for magical scroll interactions.
...
* [Wow](https://github.com/matthieua/WOW) ⭐ 9,895 | 🐛 191 | 🌐 JavaScript | 📅 2024-06-24 - Reveal CSS animation as you scroll down a page.
* [Locomotive Scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,864 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detection of elements in viewport and smooth scrolling with parallax.
...
* [Atropos](https://github.com/nolimits4web/atropos) ⭐ 3,605 | 🐛 7 | 🌐 JavaScript | 📅 2026-05-20 - Touch-friendly 3D parallax hover effects.
...
* [Typed.js](https://github.com/mattboldt/typed.js) ⭐ 16,277 | 🐛 22 | 🌐 JavaScript | 📅 2026-01-25 - A JavaScript Typing Animation Library.
* [NumberFlow](https://github.com/barvian/number-flow) ⭐ 7,717 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-20 - Animated number component for React, Vue, Svelte, and vanilla JS.
...
* [TypewriterJS](https://github.com/tameemsafi/typewriterjs) ⭐ 2,672 | 🐛 94 | 🌐 JavaScript | 📅 2025-04-29 - Native JavaScript plugin for typewriter text effects.
...
* [Remotion](https://github.com/remotion-dev/remotion) ⭐ 60,495 | 🐛 199 | 🌐 TypeScript | 📅 2026-09-26 - Create videos programmatically with React.
* [Motion](https://github.com/framer/motion) ⭐ 33,734 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-25 - Open source, production-ready animation and gesture library for React.
* [React Three Fiber](https://github.com/pmndrs/react-three-fiber) ⭐ 32,519 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-26 - A React renderer for Three.js.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,061 | 🐛 150 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React Transition Group](https://github.com/reactjs/react-transition-group) ⭐ 10,217 | 🐛 258 | 🌐 JavaScript | 📅 2026-03-05 - Perform animations when a React component enters or leaves the DOM.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,984 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-25 - ReactJS wrapper for *tsParticles*
...
* [Rive React](https://github.com/rive-app/rive-react) ⭐ 1,162 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-24 - React runtime for interactive Rive animations.
