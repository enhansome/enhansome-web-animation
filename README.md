...
* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 72,708 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 28,282 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
* [Mojs](https://github.com/mojs/mojs) ⭐ 18,763 | 🐛 37 | 🌐 CoffeeScript | 📅 2026-07-30 - The motion graphics toolbelt for the web.
...
* [Animateplus](https://github.com/bendc/animateplus) ⭐ 5,948 | 🐛 0 | 🌐 JavaScript | 📅 2018-07-10 - A+ animation module for the modern web.
* [Move.js](https://github.com/visionmedia/move.js) ⭐ 4,691 | 🐛 36 | 🌐 JavaScript | 📅 2022-03-11 - CSS3 backed JavaScript animation framework.
* [TweenJS](https://github.com/CreateJS/TweenJS) ⭐ 3,542 | 🐛 12 | 🌐 JavaScript | 📅 2023-12-18 - A simple but powerful tweening / animation library for JavaScript. Part of the CreateJS suite of libraries.
...
* [Bezier easing](https://github.com/gre/bezier-easing) ⭐ 1,775 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-05 - Cubic-bezier implementation for your JavaScript animation easings.
...
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,428 | 🐛 469 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript canvas library with animation support.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,074 | 🐛 430 | 🌐 JavaScript | 📅 2024-07-23 - The Swiss Army Knife of Vector Graphics Scripting – Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
* [Konva](https://github.com/konvajs/konva) ⭐ 14,765 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-04 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,978 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
* [Two.js](https://github.com/jonobr1/two.js) ⭐ 8,656 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-05 - A renderer agnostic two-dimensional drawing api for the web with animation support.
...
* [Pts.js](https://github.com/williamngan/pts) ⭐ 5,341 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-05 - Pts is a typescript/javascript library for visualization and creative-coding.
* [Hover-effect](https://github.com/robin-dela/hover-effect) ⭐ 1,882 | 🐛 24 | 🌐 HTML | 📅 2023-06-27 - JavaScript library to draw and animate images on hover.
* [Curtainsjs](https://github.com/martinlaxenaire/curtainsjs) ⭐ 1,823 | 🐛 12 | 🌐 JavaScript | 📅 2025-04-03 - Lightweight vanilla WebGL JavaScript library that turns HTML DOM elements into interactive textured planes.
* [Ocanvas](https://github.com/koggdal/ocanvas) ⭐ 488 | 🐛 33 | 🌐 JavaScript | 📅 2023-06-24 - JavaScript library for object-based canvas drawing.

## Animate on scroll

* [AOS](https://github.com/michalsnik/aos) ⭐ 28,053 | 🐛 375 | 🌐 JavaScript | 📅 2024-03-26 - Animate on scroll library.
...
* [ScrollMagic](https://github.com/janpaepke/ScrollMagic) ⭐ 14,959 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-07 - The JavaScript library for magical scroll interactions.
...
* [Typed.js](https://github.com/mattboldt/typed.js) ⭐ 16,284 | 🐛 22 | 🌐 JavaScript | 📅 2026-01-25 - A JavaScript Typing Animation Library.
* [Blotter](https://github.com/bradley/Blotter) ⭐ 3,076 | 🐛 20 | 🌐 JavaScript | 📅 2020-07-28 - A JavaScript API for drawing unconventional text effects on the web.
...
* [Motion](https://github.com/framer/motion) ⭐ 33,517 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-02 - Open source, production-ready animation and gesture library for React.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,059 | 🐛 149 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,978 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02 - ReactJS wrapper for *tsParticles*
