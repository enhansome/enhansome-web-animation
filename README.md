...
* [Vivus](https://github.com/maxwellito/vivus) ⭐ 15,482 | 🐛 22 | 🌐 JavaScript | 📅 2022-07-06 - Library to make drawing animation on SVG.
...
* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 72,791 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 28,367 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
* [Mojs](https://github.com/mojs/mojs) ⭐ 18,767 | 🐛 37 | 🌐 CoffeeScript | 📅 2026-07-30 - The motion graphics toolbelt for the web.
...
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,436 | 🐛 469 | 🌐 TypeScript | 📅 2026-09-09 - JavaScript canvas library with animation support.
...
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,979 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-12 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
* [Two.js](https://github.com/jonobr1/two.js) ⭐ 8,657 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-12 - A renderer agnostic two-dimensional drawing api for the web with animation support.
...
* [Pts.js](https://github.com/williamngan/pts) ⭐ 5,342 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-12 - Pts is a typescript/javascript library for visualization and creative-coding.
...
* [Motion](https://github.com/framer/motion) ⭐ 33,572 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-12 - Open source, production-ready animation and gesture library for React.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,057 | 🐛 150 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,979 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-12 - ReactJS wrapper for *tsParticles*
