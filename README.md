# Awesome Web Animation with stars
...
* [Lottie](https://github.com/airbnb/lottie-web) ⭐ 32,117 | 🐛 857 | 🌐 JavaScript | 📅 2025-09-01 - Render After Effects animations natively on the web as SVG or Canvas.
* [Vivus](https://github.com/maxwellito/vivus) ⭐ 15,481 | 🐛 22 | 🌐 JavaScript | 📅 2022-07-06 - Library to make drawing animation on SVG.
* [Snap.svg](https://github.com/adobe-webplatform/Snap.svg) ⭐ 14,009 | 🐛 268 | 🌐 JavaScript | 📅 2026-06-12 - The JavaScript library for modern SVG graphics.
* [Svg.js](https://github.com/svgdotjs/svg.js) ⭐ 11,830 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-04 - The lightweight library for manipulating and animating SVG.
* [Raphael](https://github.com/DmitryBaranovskiy/raphael) ⭐ 11,265 | 🐛 347 | 🌐 JavaScript | 📅 2024-01-12 - JavaScript Vector Library.
* [Flubber](https://github.com/veltman/flubber) ⭐ 6,936 | 🐛 19 | 🌐 JavaScript | 📅 2022-11-08 - Tools for smoother SVG shape morphing and interpolation.
* [Walkway](https://github.com/ConnorAtherton/walkway) ⭐ 4,344 | 🐛 4 | 🌐 JavaScript | 📅 2022-03-13 - An easy way to animate SVG elements.
* [Lazy Line Painter](https://github.com/merri-ment/lazy-line-painter) ⭐ 1,981 | 🐛 16 | 🌐 JavaScript | 📅 2023-12-12 - A modern JavaScript library for SVG path animation.
* [Bonsai](https://github.com/uxebu/bonsai) ⭐ 1,962 | 🐛 93 | 🌐 JavaScript | 📅 2017-12-18 - BonsaiJS is a graphics library and renderer.

## Common

* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 73,030 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 28,555 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
* [Popmotion](https://github.com/Popmotion/popmotion) ⭐ 20,154 | 🐛 50 | 🌐 JavaScript | 📅 2024-03-12 - Simple animation libraries for delightful user interfaces.
* [Mojs](https://github.com/mojs/mojs) ⭐ 18,778 | 🐛 37 | 🌐 CoffeeScript | 📅 2026-07-30 - The motion graphics toolbelt for the web.
* [Velocity](https://github.com/julianshapiro/velocity) ⭐ 17,194 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [AutoAnimate](https://github.com/formkit/auto-animate) ⭐ 13,922 | 🐛 44 | 🌐 TypeScript | 📅 2026-07-10 - Zero-config, drop-in animation utility for smooth DOM transitions.
* [Theatre.js](https://github.com/theatre-js/theatre) ⭐ 12,690 | 🐛 141 | 🌐 TypeScript | 📅 2024-08-14 - Motion design editor for the web.
* [Progressbar.js](https://github.com/kimmobrunfeldt/progressbar.js) ⭐ 7,852 | 🐛 69 | 🌐 JavaScript | 📅 2024-11-02 - Responsive and slick progress bars.
* [Animateplus](https://github.com/bendc/animateplus) ⭐ 5,947 | 🐛 0 | 🌐 JavaScript | 📅 2018-07-10 - A+ animation module for the modern web.
* [Move.js](https://github.com/visionmedia/move.js) ⭐ 4,688 | 🐛 36 | 🌐 JavaScript | 📅 2022-03-11 - CSS3 backed JavaScript animation framework.
* [TweenJS](https://github.com/CreateJS/TweenJS) ⭐ 3,543 | 🐛 12 | 🌐 JavaScript | 📅 2023-12-18 - A simple but powerful tweening / animation library for JavaScript. Part of the CreateJS suite of libraries.
...
* [Bezier easing](https://github.com/gre/bezier-easing) ⭐ 1,775 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-19 - Cubic-bezier implementation for your JavaScript animation easings.
* [Animatic](https://github.com/lvivski/animatic) ⭐ 1,382 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-31 - CSS animations engine.
* [Rive](https://github.com/rive-app/rive-wasm) ⭐ 968 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-22 - Web runtime for interactive Rive animations.
...
* [Weeee.js](https://github.com/sfi0zy/weeee) ⚠️ Archived - Tiny Javascript tweening engine.
...
* [Hover.css](https://github.com/IanLunn/Hover) ⭐ 29,400 | 🐛 42 | 🌐 SCSS | 📅 2023-10-28 - A collection of CSS3 powered hover effects.
...
* [Magic](https://github.com/miniMAC/magic) ⭐ 8,603 | 🐛 0 | 🌐 SCSS | 📅 2022-08-23 - CSS3 Animations with special effects.
...
* [Bounce.js](https://github.com/tictail/bounce.js) ⭐ 6,153 | 🐛 12 | 🌐 CSS | 📅 2020-09-03 - Create beautiful CSS3 powered animations in no time.
* [CSS Doodle](https://github.com/css-doodle/css-doodle) ⭐ 6,041 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-20 - A web component for drawing patterns with CSS.
* [CSShake](https://github.com/elrumordelaluz/csshake) ⭐ 4,867 | 🐛 3 | 🌐 SCSS | 📅 2024-06-19 - CSS classes to shake your DOM.
* [AnimXYZ](https://github.com/ingram-projects/animxyz) ⭐ 2,499 | 🐛 41 | 🌐 CSS | 📅 2026-09-18 - Composable CSS animation toolkit powered by CSS variables.
...
* [Three.js](https://github.com/mrdoob/three.js) ⭐ 115,741 | 🐛 380 | 🌐 JavaScript | 📅 2026-09-22 - JavaScript 3D library.
* [PixiJS](https://github.com/pixijs/pixijs) ⭐ 48,201 | 🐛 344 | 🌐 TypeScript | 📅 2026-09-17 - Fast 2D WebGL renderer for interactive graphics and animation.
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,454 | 🐛 471 | 🌐 TypeScript | 📅 2026-09-22 - JavaScript canvas library with animation support.
* [p5.js](https://github.com/processing/p5.js) ⭐ 24,022 | 🐛 526 | 🌐 JavaScript | 📅 2026-09-21 - Creative coding library for drawing and animation on canvas.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,814 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-19 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [canvas-confetti](https://github.com/catdad/canvas-confetti) ⭐ 12,759 | 🐛 41 | 🌐 JavaScript | 📅 2025-10-25 - Performant confetti animation in the browser.
* [Zdog](https://github.com/metafizzy/zdog) ⭐ 10,664 | 🐛 55 | 🌐 JavaScript | 📅 2023-07-18 - Round, flat, designer-friendly pseudo-3D engine for canvas and SVG.
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,985 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-21 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
* [Two.js](https://github.com/jonobr1/two.js) ⭐ 8,661 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-22 - A renderer agnostic two-dimensional drawing api for the web with animation support.
* [EaselJS](https://github.com/CreateJS/EaselJS) ⭐ 8,156 | 🐛 221 | 🌐 JavaScript | 📅 2026-01-24 - EaselJS is a library for building high-performance interactive 2D content in HTML5.
* [Vanta.js](https://github.com/tengbao/vanta) ⭐ 7,047 | 🐛 77 | 🌐 JavaScript | 📅 2024-03-03 - Animated 3D backgrounds for your website.
* [Pts.js](https://github.com/williamngan/pts) ⭐ 5,347 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-19 - Pts is a typescript/javascript library for visualization and creative-coding.
* [Hover-effect](https://github.com/robin-dela/hover-effect) ⭐ 1,883 | 🐛 24 | 🌐 HTML | 📅 2023-06-27 - JavaScript library to draw and animate images on hover.
* [Curtainsjs](https://github.com/martinlaxenaire/curtainsjs) ⭐ 1,826 | 🐛 12 | 🌐 JavaScript | 📅 2025-04-03 - Lightweight vanilla WebGL JavaScript library that turns HTML DOM elements into interactive textured planes.
* [Ocanvas](https://github.com/koggdal/ocanvas) ⭐ 488 | 🐛 33 | 🌐 JavaScript | 📅 2023-06-24 - JavaScript library for object-based canvas drawing.

## Animate on scroll

* [AOS](https://github.com/michalsnik/aos) ⭐ 28,050 | 🐛 375 | 🌐 JavaScript | 📅 2024-03-26 - Animate on scroll library.
* [Scrollreveal](https://github.com/scrollreveal/scrollreveal) ⭐ 22,476 | 🐛 41 | 🌐 JavaScript | 📅 2024-04-05 - Animate elements as they scroll into view.
* [Lenis](https://github.com/darkroomengineering/lenis) ⭐ 15,945 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-18 - Lightweight, accessible smooth scroll library.
* [ScrollMagic](https://github.com/janpaepke/ScrollMagic) ⭐ 14,958 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-11 - The JavaScript library for magical scroll interactions.
...
* [Wow](https://github.com/matthieua/WOW) ⭐ 9,898 | 🐛 191 | 🌐 JavaScript | 📅 2024-06-24 - Reveal CSS animation as you scroll down a page.
* [Locomotive Scroll](https://github.com/locomotivemtl/locomotive-scroll) ⭐ 8,862 | 🐛 25 | 🌐 JavaScript | 📅 2026-06-30 - Detection of elements in viewport and smooth scrolling with parallax.
* [Rellax](https://github.com/dixonandmoe/rellax) ⭐ 7,131 | 🐛 77 | 🌐 HTML | 📅 2024-08-24 - Lightweight vanilla JavaScript parallax library.
* [Sal](https://github.com/mciastek/sal) ⭐ 3,693 | 🐛 42 | 🌐 HTML | 📅 2023-01-07 - Performance focused, lightweight scroll animation library.
...
* [Typed.js](https://github.com/mattboldt/typed.js) ⭐ 16,278 | 🐛 22 | 🌐 JavaScript | 📅 2026-01-25 - A JavaScript Typing Animation Library.
* [NumberFlow](https://github.com/barvian/number-flow) ⭐ 7,707 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-20 - Animated number component for React, Vue, Svelte, and vanilla JS.
* [TypeIt](https://github.com/alexmacarthur/typeit) ⭐ 3,178 | 🐛 23 | 🌐 JavaScript | 📅 2025-04-04 - The most versatile JavaScript typewriter effect library.
* [Blotter](https://github.com/bradley/Blotter) ⭐ 3,079 | 🐛 20 | 🌐 JavaScript | 📅 2020-07-28 - A JavaScript API for drawing unconventional text effects on the web.
...
* [Splitting](https://github.com/shshaw/Splitting) ⭐ 1,758 | 🐛 46 | 🌐 JavaScript | 📅 2024-06-19 - Microlibrary to split text into words and characters for CSS animation.
...
* [Typebot](https://github.com/akzhy/typebot) ⚠️ Archived - JavaScript library for typing animation.

## React

* [Remotion](https://github.com/remotion-dev/remotion) ⭐ 60,001 | 🐛 187 | 🌐 TypeScript | 📅 2026-09-22 - Create videos programmatically with React.
* [Motion](https://github.com/framer/motion) ⭐ 33,684 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-22 - Open source, production-ready animation and gesture library for React.
* [React Three Fiber](https://github.com/pmndrs/react-three-fiber) ⭐ 32,420 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-20 - A React renderer for Three.js.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,061 | 🐛 150 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React Transition Group](https://github.com/reactjs/react-transition-group) ⭐ 10,218 | 🐛 258 | 🌐 JavaScript | 📅 2026-03-05 - Perform animations when a React component enters or leaves the DOM.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,985 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-21 - ReactJS wrapper for *tsParticles*
* [React Flip Toolkit](https://github.com/aholachek/react-flip-toolkit) ⭐ 4,187 | 🐛 60 | 🌐 TypeScript | 📅 2024-09-28 - Lightweight magic-move library for configurable layout transitions.
* [Rive React](https://github.com/rive-app/rive-react) ⭐ 1,159 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-16 - React runtime for interactive Rive animations.
* [Lottie React](https://github.com/Gamote/lottie-react) ⭐ 968 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-07 - React component for rendering Lottie animations.
