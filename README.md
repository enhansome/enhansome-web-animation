...
* [Svg.js](https://github.com/svgdotjs/svg.js) ⭐ 11,824 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-04 - The lightweight library for manipulating and animating SVG.
...
* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 72,814 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 28,399 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
* [Mojs](https://github.com/mojs/mojs) ⭐ 18,768 | 🐛 37 | 🌐 CoffeeScript | 📅 2026-07-30 - The motion graphics toolbelt for the web.
...
* [Animate.css](https://github.com/daneden/animate.css) ⭐ 82,786 | 🐛 80 | 🌐 CSS | 📅 2024-07-29 -  A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,440 | 🐛 466 | 🌐 TypeScript | 📅 2026-09-13 - JavaScript canvas library with animation support.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,789 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,980 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-13 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
* [Two.js](https://github.com/jonobr1/two.js) ⭐ 8,658 | 🐛 40 | 🌐 JavaScript | 📅 2026-09-12 - A renderer agnostic two-dimensional drawing api for the web with animation support.
...
* [Pts.js](https://github.com/williamngan/pts) ⭐ 5,344 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-13 - Pts is a typescript/javascript library for visualization and creative-coding.
...
* [Scrollreveal](https://github.com/scrollreveal/scrollreveal) ⭐ 22,477 | 🐛 41 | 🌐 JavaScript | 📅 2024-04-05 - Animate elements as they scroll into view.
...
* [Motion](https://github.com/framer/motion) ⭐ 33,599 | 🐛 114 | 🌐 TypeScript | 📅 2026-09-14 - Open source, production-ready animation and gesture library for React.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,057 | 🐛 150 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,980 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-13 - ReactJS wrapper for *tsParticles*
