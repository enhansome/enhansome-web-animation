...
* [Snap.svg](https://github.com/adobe-webplatform/Snap.svg) ⭐ 14,009 | 🐛 267 | 🌐 JavaScript | 📅 2026-06-12 - The JavaScript library for modern SVG graphics.
...
* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 72,291 | 🐛 115 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 27,893 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
* [Mojs](https://github.com/mojs/mojs) ⭐ 18,754 | 🐛 37 | 🌐 CoffeeScript | 📅 2026-07-30 - The motion graphics toolbelt for the web.
...
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,395 | 🐛 468 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript canvas library with animation support.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,707 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-20 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,959 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
...
* [EaselJS](https://github.com/CreateJS/EaselJS) ⭐ 8,159 | 🐛 221 | 🌐 JavaScript | 📅 2026-01-24 - EaselJS is a library for building high-performance interactive 2D content in HTML5.
* [Pts.js](https://github.com/williamngan/pts) ⭐ 5,340 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-20 - Pts is a typescript/javascript library for visualization and creative-coding.
...
* [AOS](https://github.com/michalsnik/aos) ⭐ 28,059 | 🐛 374 | 🌐 JavaScript | 📅 2024-03-26 - Animate on scroll library.
* [Scrollreveal](https://github.com/scrollreveal/scrollreveal) ⭐ 22,470 | 🐛 41 | 🌐 JavaScript | 📅 2024-04-05 - Animate elements as they scroll into view.
* [ScrollMagic](https://github.com/janpaepke/ScrollMagic) ⭐ 14,954 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-04 - The JavaScript library for magical scroll interactions.
...
* [Motion](https://github.com/framer/motion) ⭐ 33,299 | 🐛 105 | 🌐 TypeScript | 📅 2026-08-20 - Open source, production-ready animation and gesture library for React.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,051 | 🐛 148 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,959 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - ReactJS wrapper for *tsParticles*
