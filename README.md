...
* [Svg.js](https://github.com/svgdotjs/svg.js) ⭐ 11,822 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-04 - The lightweight library for manipulating and animating SVG.
...
* [Bonsai](https://github.com/uxebu/bonsai) ⭐ 1,963 | 🐛 93 | 🌐 JavaScript | 📅 2017-12-18 - BonsaiJS is a graphics library and renderer.

## Common

* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 72,646 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 28,235 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
* [Mojs](https://github.com/mojs/mojs) ⭐ 18,762 | 🐛 37 | 🌐 CoffeeScript | 📅 2026-07-30 - The motion graphics toolbelt for the web.
* [Velocity](https://github.com/julianshapiro/velocity) ⭐ 17,198 | 🐛 40 | 🌐 JavaScript | 📅 2020-10-24 - Accelerated JavaScript animation.
* [Progressbar.js](https://github.com/kimmobrunfeldt/progressbar.js) ⭐ 7,855 | 🐛 69 | 🌐 JavaScript | 📅 2024-11-02 - Responsive and slick progress bars.
* [Animateplus](https://github.com/bendc/animateplus) ⭐ 5,949 | 🐛 0 | 🌐 JavaScript | 📅 2018-07-10 - A+ animation module for the modern web.
...
* [Animo.js](https://github.com/ThrivingKings/animo.js) ⭐ 2,086 | 🐛 7 | 🌐 CSS | 📅 2017-04-05 - A powerful little tool for managing CSS animations.
* [Bezier easing](https://github.com/gre/bezier-easing) ⭐ 1,776 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-03 - Cubic-bezier implementation for your JavaScript animation easings.
* [Animatic](https://github.com/lvivski/animatic) ⭐ 1,383 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-31 - CSS animations engine.
...
* [Between.js](https://github.com/sasha240100/between.js) ⭐ 707 | 🐛 17 | 🌐 JavaScript | 📅 2023-04-24 - Lightweight JavaScript (ES6) tweening engine.
...
* [Animate.css](https://github.com/daneden/animate.css) ⭐ 82,777 | 🐛 80 | 🌐 CSS | 📅 2024-07-29 -  A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [Bounce.js](https://github.com/tictail/bounce.js) ⭐ 6,158 | 🐛 12 | 🌐 CSS | 📅 2020-09-03 - Create beautiful CSS3 powered animations in no time.
...
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,422 | 🐛 469 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript canvas library with animation support.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,753 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,974 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
* [Two.js](https://github.com/jonobr1/two.js) ⭐ 8,654 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-01 - A renderer agnostic two-dimensional drawing api for the web with animation support.
* [EaselJS](https://github.com/CreateJS/EaselJS) ⭐ 8,157 | 🐛 221 | 🌐 JavaScript | 📅 2026-01-24 - EaselJS is a library for building high-performance interactive 2D content in HTML5.
* [Pts.js](https://github.com/williamngan/pts) ⭐ 5,342 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-04 - Pts is a typescript/javascript library for visualization and creative-coding.
* [Hover-effect](https://github.com/robin-dela/hover-effect) ⭐ 1,881 | 🐛 24 | 🌐 HTML | 📅 2023-06-27 - JavaScript library to draw and animate images on hover.
* [Curtainsjs](https://github.com/martinlaxenaire/curtainsjs) ⭐ 1,824 | 🐛 12 | 🌐 JavaScript | 📅 2025-04-03 - Lightweight vanilla WebGL JavaScript library that turns HTML DOM elements into interactive textured planes.
* [Ocanvas](https://github.com/koggdal/ocanvas) ⭐ 488 | 🐛 33 | 🌐 JavaScript | 📅 2023-06-24 - JavaScript library for object-based canvas drawing.

## Animate on scroll

* [AOS](https://github.com/michalsnik/aos) ⭐ 28,058 | 🐛 374 | 🌐 JavaScript | 📅 2024-03-26 - Animate on scroll library.
...
* [ScrollMagic](https://github.com/janpaepke/ScrollMagic) ⭐ 14,958 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-03 - The JavaScript library for magical scroll interactions.
...
* [Wow](https://github.com/matthieua/WOW) ⭐ 9,900 | 🐛 191 | 🌐 JavaScript | 📅 2024-06-24 - Reveal CSS animation as you scroll down a page.
...
* [Typed.js](https://github.com/mattboldt/typed.js) ⭐ 16,282 | 🐛 22 | 🌐 JavaScript | 📅 2026-01-25 - A JavaScript Typing Animation Library.
* [Blotter](https://github.com/bradley/Blotter) ⭐ 3,077 | 🐛 20 | 🌐 JavaScript | 📅 2020-07-28 - A JavaScript API for drawing unconventional text effects on the web.
...
* [Motion](https://github.com/framer/motion) ⭐ 33,478 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-02 - Open source, production-ready animation and gesture library for React.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,059 | 🐛 149 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,974 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02 - ReactJS wrapper for *tsParticles*
