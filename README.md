...
* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 72,221 | 🐛 115 | 🌐 JavaScript | 📅 2026-08-17 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 27,794 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
...
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,389 | 🐛 467 | 🌐 TypeScript | 📅 2026-08-08 - JavaScript canvas library with animation support.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,694 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-15 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,953 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
...
* [Pts.js](https://github.com/williamngan/pts) ⭐ 5,340 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-16 - Pts is a typescript/javascript library for visualization and creative-coding.
...
* [Motion](https://github.com/framer/motion) ⭐ 33,269 | 🐛 112 | 🌐 TypeScript | 📅 2026-08-17 - Open source, production-ready animation and gesture library for React.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,049 | 🐛 148 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,953 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - ReactJS wrapper for *tsParticles*
