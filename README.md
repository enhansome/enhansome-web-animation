...
* [Anime.js](https://github.com/juliangarnier/anime) ⭐ 72,843 | 🐛 118 | 🌐 JavaScript | 📅 2026-08-21 - JavaScript animation engine.
* [GSAP](https://github.com/greensock/GSAP) ⭐ 28,423 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13 - JavaScript animation library.
* [Mojs](https://github.com/mojs/mojs) ⭐ 18,769 | 🐛 37 | 🌐 CoffeeScript | 📅 2026-07-30 - The motion graphics toolbelt for the web.
...
* [Animate.css](https://github.com/daneden/animate.css) ⭐ 82,788 | 🐛 80 | 🌐 CSS | 📅 2024-07-29 -  A cross-browser library of CSS animations. As easy to use as an easy thing.
...
* [Fabric.js](https://github.com/fabricjs/fabric.js) ⭐ 31,439 | 🐛 469 | 🌐 TypeScript | 📅 2026-09-15 - JavaScript canvas library with animation support.
...
* [tsParticles](https://github.com/matteobruni/tsparticles/) ⭐ 8,982 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-14 - tsParticles is a lightweight typescript/javascript library for creating easily particles animations.
* [Two.js](https://github.com/jonobr1/two.js) ⭐ 8,658 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-15 - A renderer agnostic two-dimensional drawing api for the web with animation support.
...
* [Motion](https://github.com/framer/motion) ⭐ 33,611 | 🐛 112 | 🌐 TypeScript | 📅 2026-09-14 - Open source, production-ready animation and gesture library for React.
* [SVGR](https://github.com/gregberge/svgr) ⭐ 11,057 | 🐛 150 | 🌐 TypeScript | 📅 2026-03-01 - Transform SVGs into React components.
* [React tsParticles](https://github.com/matteobruni/tsparticles/blob/master/components/react/README.md) ⭐ 8,982 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-14 - ReactJS wrapper for *tsParticles*
